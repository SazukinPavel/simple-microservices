...
export class LogsService extends ConsoleLogger {
    ...
    error(message: any, stack?: string, context?: string) {
        super.error(message);
        this.addLog({
            context, data: message, stack, level: 'error'
        })
    }
    ...
    warn(message: any, stack?: string, context?: string) {
        super.warn(message);
        this.addLog({
            context, data: message, stack, level: 'warn'
        })
    }
    ...
    debug(message: any, stack?: string, context?: string) {
        super.debug(message);
        this.addLog({
            context, data: message, stack, level: 'debug'
        })
    }
    ...
    verbose(message: any, stack?: string, context?: string) {
        ...
        this.addLog({
            context, data: message, stack, level: 'verbose'
        })
    }
    ...
    log(message: any, stack?: string, context?: string) {
        super.log(message);
        this.addLog({
            context, data: message, stack, level: 'log'
        })
    }
}
